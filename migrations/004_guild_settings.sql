...
--
-- `view_permission` controls who can view the optional public birthdays
-- page: 'managers' (default — Manage Server only), 'members' (any member of
-- the guild), or 'disabled' to hide it entirely.
